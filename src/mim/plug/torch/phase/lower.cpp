...
#define MIM_BIND_TORCH_SUB(family, src, legacy)                                      \
    ...
    MIM_BIND_TORCH_SUB(loss, smooth_l1_loss, smooth_l1_loss_op);
    MIM_BIND_TORCH_SUB(loss, kl_div, kl_div_op);
    MIM_BIND_TORCH_SUB(loss, triplet_margin_loss, triplet_margin_loss_op);
    MIM_BIND_TORCH_SUB(loss, triplet_margin_loss_1d_none, triplet_margin_loss_1d_none_op);
    ...
    MIM_BIND_TORCH_SUB(reduction, mean, mean_op);
    MIM_BIND_TORCH_SUB(reduction, amax, amax_op);
    ...
    MIM_BIND_TORCH_SUB(reduction, var_mean, var_mean_op);
    MIM_BIND_TORCH_SUB(reduction, logsumexp, logsumexp_op);
