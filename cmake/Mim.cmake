...
function(mim_static_plugin_registry TARGET)
    ...
    set(GENERATED ${CMAKE_BINARY_DIR}/src/mim/static_plugins.cpp)
    file(CONFIGURE
        OUTPUT ${GENERATED}
...
"
    ...
    target_link_libraries(${TARGET} PUBLIC ${MIM_TARGET_NAMESPACE}libmim)
    foreach(PLUGIN IN LISTS ARGN)
        target_link_libraries(${TARGET} PUBLIC mim_${PLUGIN})
    endforeach()
endfunction()
