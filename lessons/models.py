...
class LessonFollowsFromLesson(models.Model):
    leads_from = models.ForeignKey(Lesson, related_name='preparation')
    leads_to = models.ForeignKey(Lesson, related_name='supplement') #TODO think about these two related names, do they make sense?
