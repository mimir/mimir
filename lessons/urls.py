...
urlpatterns = patterns('',
    ...
    url(r'^(?P<lesson_url>[-\w]+)/$', views.read, name = 'read'),
    url(r'^(?P<lesson_url>[-\w]+)/test/(?P<question_id>\d+)/$', views.question, name = 'question'),
    url(r'^(?P<lesson_url>[-\w]+)/test/$', views.rand_question, name = 'rand_question'),
